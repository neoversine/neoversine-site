...
const defaultItems = [
    {
        ...
        link: 'https://google.c0m/',
        title: '',
        description: ''
    },
];

export default function InfiniteMenu({ items = [], onScrollDown }) {
    ...
    return (
        <div className="relative w-full h-full overflow-hidden ">
          ...
          transition-all
        text-white
        [text-shadow:_-1px_-1px_0_black,_1px_-1px_0_black,_-1px_1px_0_black,_1px_1px_0_black]
        ...
        `}
          ...
          ${isMoving
                                ...
                                : 'bottom-[3.8em] md:bottom-[5em] opacity-100 pointer-events-auto duration-[500ms] scale-100 -translate-x-1/2'
                            }
        `}

                    >
                        <p className="select-none relative text-[#000000] top-[2px] max-md:text-xs text-[15px]">
                            Hold and Rotate
                        </p>
                    </div>
          ...
          ${isMoving
                                ? 'bottom-[-80px] opacity-0 pointer-events-none duration-[100ms] scale-0 -translate-x-1/2'
                                : 'bottom-[10em] md:bottom-[5em] opacity-100 pointer-events-auto duration-[500ms] scale-100 -translate-x-1/2'
                            }
        `}
